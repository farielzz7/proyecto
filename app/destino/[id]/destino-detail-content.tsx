...
type DestinoDetailContentProps = {
  destinoId: string
}
...
type DestinosData = typeof destinosData

export default function DestinoDetailContent({ destinoId }: DestinoDetailContentProps) {
  // Asegurar que la página se cargue desde arriba
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [])

  const destinoKey = destinoId as keyof DestinosData
  const destino =
    destinoId in destinosData ? destinosData[destinoKey] : destinosData.default
                ...
                <div className="space-y-4">
                  <div className="border-l-2 border-teal-700 pl-4 pb-6 relative">
                    ...
                    <p className="text-muted-foreground mb-3">
                      Recogida en su hotel y traslado al sitio arqueológico. A la llegada, nuestro guía especializado le dará una introducción a la historia y significado cultural del sitio.
                    </p>
                  ...
                  <div className="border-l-2 border-teal-700 pl-4 pb-6 relative">
                    ...
                    <p className="text-muted-foreground mb-3">
                      Disfrutará de un almuerzo tradicional con platos regionales. Después, tendrá tiempo libre para explorar por su cuenta o descansar en un área sombreada.
                    </p>
                    <div className="bg-stone-50 p-3 rounded-md">
                  ...
                  <div className="border-l-2 border-teal-700 pl-4 relative">
                    ...
                    <p className="text-muted-foreground mb-3">
                      Continuaremos explorando otras secciones del sitio arqueológico. Finalizaremos con una visita a un cenote cercano donde podrá refrescarse con un baño opcional.
                    </p>
                    <div className="bg-stone-50 p-3 rounded-md">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-sm mb-2">
                      "El tour fue muy bien organizado. Aprendimos mucho sobre la cultura maya y disfrutamos cada momento. La comida fue excelente y el transporte muy cómodo."
                    </p>
                  </div>
